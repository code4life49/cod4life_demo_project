...
public class InstallSTLReader implements ISTLReader {
    ...
    public STLModel parserBinStl(byte[] stlBytes) {
        ...
        switch (1) {
            case 1:
//                center_x = (maxX - minX) / 2 + 10;
//                center_y = (maxY - minY) / 2 + 20;
//                center_z = -100;
                center_x = (maxX - minX) / 2 + 75;
                center_y = (maxY - minY) / 2 + 146;
                center_z = (maxZ - minZ) / 2 - 252;
                Log.d(TAG, "parserBinStl: " + String.format("x=%f,y=%f,z=%f", center_x, center_y, center_z));
                break;
            case 2:
                break;
        }
