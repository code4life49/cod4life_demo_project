...
public class BInstallSTLReader implements ISTLReader {
    ...
    public STLModel parserBinStl(byte[] stlBytes) {
        ...
        switch (1) {
            case 1:
                center_x = MyStlUtils.getStlDataEnum().getCenterX();
                center_y = MyStlUtils.getStlDataEnum().getCenterY();
                center_z = MyStlUtils.getStlDataEnum().getCenterZ();
                break;
            case 2:
                break;
        }
