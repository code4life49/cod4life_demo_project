...
public class BSTLReader implements ISTLReader {
    ...
    public STLModel parserBinStl(byte[] stlBytes) {
        ...
        switch (1) {
            case 1:
                center_x = MeasureAdjustStlUtils.getStlDataEnum().getCenterX();
                center_y = MeasureAdjustStlUtils.getStlDataEnum().getCenterY();
                center_z = MeasureAdjustStlUtils.getStlDataEnum().getCenterZ();
                break;
            case 2:
                break;
        }
