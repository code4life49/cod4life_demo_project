...
public class MeasureBeforeSTLView extends GLSurfaceView {
    ...
    public MeasureBeforeSTLView(Context context) {
        this(context, null);
    }

    public MeasureBeforeSTLView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init() {
        ...
        stlRenderer = new MeasureBeforeSTLRenderer();
    ...
    public void rotate(float x, float y, float z) {
        stlRenderer.sAngleX = x;
        stlRenderer.sAngleY = y;
        stlRenderer.sAngleZ = z;
        requestRedraw();
    }

    public void initPosition1(float initPositionX, float initPositionY, float initPositionZ) {
        stlRenderer.initPosition1X = initPositionX;
        stlRenderer.initPosition1Y = initPositionY;
        stlRenderer.initPosition1Z = initPositionZ;
        requestRedraw();
    }

    public void initPosition2(float initPositionX, float initPositionY, float initPositionZ) {
        stlRenderer.initPosition2X = initPositionX;
        stlRenderer.initPosition2Y = initPositionY;
        stlRenderer.initPosition2Z = initPositionZ;
        requestRedraw();
    }

    public void changeAngle(float x, float y, float z) {
        stlRenderer.beforeAngleX = x;
        stlRenderer.beforeAngleY = y;
        stlRenderer.beforeAngleZ = z;
        requestRedraw();
    }
